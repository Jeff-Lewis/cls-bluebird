 ...
 * @returns {undefined}
 */
module.exports = function shimMethod(obj, methodName, args, ns) {
	// Skip non-existent methods
	if (!obj[methodName]) return;

	// Patch method
	shimmer.wrap(obj, methodName, function shimMethodCallback(original) {
		return function shimMethodApply() {
